    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('report_by', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reported_bugs', to=settings.AUTH_USER_MODEL)),
                ('resolution_version', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='programs.Version')),
            ],
            options={
                'db_table': 'bugs',
                'ordering': ['-id'],
